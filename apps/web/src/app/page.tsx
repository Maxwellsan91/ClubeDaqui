  ...
  return (
    <section className="py-16 sm:py-24">
      ...
      <div className="relative mt-8" style={fu(visible, 0.15)}>
        <div
          className="pointer-events-none absolute top-0 left-0 z-10 h-full w-16 sm:w-24"
          style={{
            background:
              "linear-gradient(to right, #fdfbf6 0%, transparent 100%)",
          }}
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute top-0 right-0 z-10 h-full w-16 sm:w-24"
          style={{
            background:
              "linear-gradient(to left, #fdfbf6 0%, transparent 100%)",
          }}
          aria-hidden="true"
        />
        <div
...
export default function HomePage() {
  ...
  const { ref: testsRef, visible: testsVisible } = useInView();
  ...
  return (
    <main className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative flex min-h-[92vh] flex-col justify-end overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-5 pt-32 pb-14 sm:px-8 sm:pb-20 lg:pb-28">
          <p
          ...
          <p className="mt-6 max-w-lg text-base leading-7 text-white/65 sm:text-lg sm:leading-8">
            ...
            nossa região tem para oferecer.
          </p>
        ...
        <div ref={howRef}>
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-3">
            {HOW_STEPS.map(({ num, title, desc }, i) => (
              ...
              >
                <span
                  className="font-display text-[4.5rem] leading-none select-none"
                  style={{ color: "rgba(181,139,74,0.35)" }}
                >
                  {num}
                </span>
                <h3 className="font-display mt-2 text-2xl text-olive-900">
                  {title}
                </h3>
      ...
      >
        <div ref={catsRef} className="mx-auto max-w-7xl">
          <p
            ...
            style={{ color: "#5a6e5c", ...fu(catsVisible, 0) }}
          >
      ...
      <section className="mx-auto max-w-7xl px-5 pb-16 sm:px-8 sm:pb-24">
        <div ref={ctaRef} style={fu(ctaVisible, 0)}>
          <div
          ...
          >
            ...
            <div className="relative max-w-2xl">
              ...
              <p className="mt-4 max-w-md text-base leading-7 text-white/60">
                Benefícios ilimitados em restaurantes, alojamentos e
                experiências locais. Membros poupam em média{" "}
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-24">
        <div
          ...
          style={{ borderColor: "rgba(36,48,41,0.1)", ...fu(b2bVisible, 0) }}
        >
          <div>
            <p
              className="text-[11px] font-semibold tracking-[0.3em] uppercase"
